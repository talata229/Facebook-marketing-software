...
namespace fbchart_csharp.API
{
    ...
    public class FB_LocationAttachment : FB_Attachment
    {
        ...
        public FB_LocationAttachment(string uid = null, double latitude = 0, double longitude = 0,
            string image_url = null, int image_width = 0, int image_height = 0, string url = null,
            string address = null)
            : base(uid)
        {
    ...
    public class FB_LiveLocationAttachment : FB_LocationAttachment
    {
        ...
        public FB_LiveLocationAttachment(string uid = null, double latitude = 0, double longitude = 0,
            string image_url = null, int image_width = 0, int image_height = 0, string url = null,
            string address = null, string name = null, string expiration_time = null, bool is_expired = false)
        ...
        public static FB_LiveLocationAttachment _from_pull(JToken data)
        {
            return new FB_LiveLocationAttachment(
                ...
                latitude: ((data.get("stopReason") == null)
                              ? data.get("coordinate")?.get("latitude")?.Value<double>() ?? 0
                              : 0) / Math.Pow(10, 8),
                longitude: ((data.get("stopReason") == null)
                               ? data.get("coordinate")?.get("longitude")?.Value<double>() ?? 0
                               : 0) / Math.Pow(10, 8),
